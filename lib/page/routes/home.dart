...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _futurePopularAnimes =
        getAnimeByRankingTypeApi(rankingType: 'bypopularity', limit: 10);
  }
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child: AppBar(
              backgroundColor:
                  _scrollOffset > 200 ? Colors.black : Colors.transparent,
              elevation: 0,
          ...
          children: [
            Positioned.fill(
              ...
              child: ScrollHomePage(
                  ...
                  futurePopularAnimes: _futurePopularAnimes),
            )),
          ],
        ));
  }
